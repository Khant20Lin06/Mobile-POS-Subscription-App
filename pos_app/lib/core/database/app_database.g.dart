...
class $CustomerLedgersTable extends CustomerLedgers
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CustomerLedger> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CustomerLedgersTable customerLedgers = $CustomerLedgersTable(
    this,
  );
...
typedef $$CustomersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CustomerLedgersTableCreateCompanionBuilder =
    CustomerLedgersCompanion Function({
      required String id,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
      Value<DateTime?> deletedAt,
...
typedef $$CustomerLedgersTableUpdateCompanionBuilder =
    CustomerLedgersCompanion Function({
      Value<String> id,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
...
class $$CustomerLedgersTableFilterComposer
    extends Composer<_$AppDatabase, $CustomerLedgersTable> {
...
class $$CustomerLedgersTableAnnotationComposer
    extends Composer<_$AppDatabase, $CustomerLedgersTable> {
  $$CustomerLedgersTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomerLedgersTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
  ...
  $$CustomerLedgersTableTableManager(
    _$AppDatabase db,
    $CustomerLedgersTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CustomerLedgersTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CustomerLedgersTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CustomerLedgersTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
...
typedef $$CustomerLedgersTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CustomerLedgersTable,
      CustomerLedger,
      ...
      (
        CustomerLedger,
        BaseReferences<_$AppDatabase, $CustomerLedgersTable, CustomerLedger>,
      ),
      CustomerLedger,
      PrefetchHooks Function()
    >;
